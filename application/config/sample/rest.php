...
//key例外
$config['auth_override_class_method_http']['receptions']['spgateway']['post'] = 'none';
$config['auth_override_class_method_http']['receptions']['test']['post'] = 'none';
$config['auth_override_class_method_http']['pay2go']['send']['get'] = 'none';
$config['auth_override_class_method_http']['payments']['auth_token']['get'] = 'none';
$config['auth_override_class_method_http']['payments']['echo']['post'] = 'none';
$config['auth_override_class_method_http']['packages']['active']['get'] = 'none';
$config['auth_override_class_method_http']['automatics']['package']['get'] = 'none';
...
|
*/
$config['rest_valid_logins'] = ['VIDOL' => '23740512'];
...
$config['rest_database_group'] = 'vidol_billing_write';
...
$config['rest_keys_table'] = 'Rest_keys_tbl';
...
$config['rest_logs_table'] = 'Rest_logs_tbl';
...
$config['rest_access_table'] = 'Rest_access_tbl';
...
$config['rest_limits_table'] = 'Rest_limits_tbl';
