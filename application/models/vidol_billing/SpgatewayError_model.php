...
class SpgatewayError_model extends CI_Model
{
	private $table_name = 'SpgatewayError_tbl';
	private $fields_pk = 'se_pk';
    ...
    public function insert_SpgatewayError_for_data($data){
    ...
    public function update_SpgatewayError_for_data($pk, $data){
    ...
    public function get_row_SpgatewayError_by_pk ($select, $pk)
    {
    	if(!empty($select)){
