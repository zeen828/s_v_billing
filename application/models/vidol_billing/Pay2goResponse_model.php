...
class Pay2goResponse_model extends CI_Model
{
	private $table_name = 'Pay2goResponse_tbl';
	private $fields_pk = 'pr_pk';
    ...
    public function insert_Pay2goResponse_for_data($data){
    ...
    public function update_Pay2goResponse_for_data($pk, $data){
    ...
    public function get_row_Pay2goResponse_by_pk ($select, $pk)
    {
    	if(!empty($select)){
